...
function SideBar()
{
  ...
  return(
     <div className='sidebar'>
        <div className='top'>
            <img className = 'menu' src = {assets.menu_icon} alt = "menu"  onClick={handleExtendedChange}></img>

            <div onClick={() => newChat()} className="new-chat">
                <img src = {assets.plus_icon} alt = "new chat"></img>
        ...
        <div className='bottom'>
            ...
            <div className="bottom-item recent-entry">
                <img src={assets.history_icon} alt="activity-history"></img>
